...
def demo_tampering():
    ...
    print("✓ Hash chain detects any modification to ledger entries")
    print("✓ Each entry is cryptographically linked to previous entry")
